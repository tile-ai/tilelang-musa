...
stage_list = [0, 2]
type_block_threads_list = [
    (torch.float16, 32, 32, 64, 32),
    (torch.float16, 32, 32, 64, 128),
    (torch.float16, 64, 64, 64, 128),
    (torch.bfloat16, 32, 32, 64, 32),
    (torch.bfloat16, 32, 32, 64, 128),
    (torch.bfloat16, 64, 64, 64, 128),
    (torch.float32, 32, 32, 64, 32),
    (torch.float32, 32, 32, 64, 128),
    (torch.float32, 64, 64, 64, 128),
    (torch.float8_e4m3fn, 32, 32, 64, 32),
    (torch.float8_e4m3fn, 32, 32, 64, 128),
    (torch.float8_e4m3fn, 64, 64, 64, 128),
]
test_params = [
    (
        elem_type,
    ...
    for (elem_type, BLOCK_M, BLOCK_N, BLOCK_K, threads) in type_block_threads_list
