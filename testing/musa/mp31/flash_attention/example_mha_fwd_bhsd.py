...
def flashattn(batch, heads, seq_q, seq_kv, dim, is_causal, block_M=256, block_N=128, num_stages=1, threads=512, producer_threads=128):
...
def main(
    ...
    if not tune:
        program = flashattn(batch, heads, seq_q, seq_kv, dim, is_causal, block_M=256, block_N=128, num_stages=1, threads=512)
        dtype = "float16"
        pass_configs = {
