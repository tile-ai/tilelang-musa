...
block_threads_stages_list = [
    # (16, 128, 16, 128, 0), qy2 required m and n must be multiple of 32
    # (16, 128, 32, 128, 0), qy2 required m and n must be multiple of 32
    # (16, 128, 64, 128, 0), qy2 required m and n must be multiple of 32
    # (16, 256, 16, 128, 0), qy2 required m and n must be multiple of 32
    # (16, 256, 32, 128, 0), qy2 required m and n must be multiple of 32
    # (16, 256, 64, 128, 0), qy2 required m and n must be multiple of 32
    # (16, 512, 16, 128, 0), qy2 required m and n must be multiple of 32
    # (16, 512, 32, 128, 0), qy2 required m and n must be multiple of 32
    # (16, 512, 64, 128, 0), qy2 required m and n must be multiple of 32
    (32, 256, 16, 128, 0),
    (32, 256, 32, 128, 0),
    (32, 256, 64, 128, 0),
    (32, 512, 16, 128, 0),
    ...
    (64, 512, 16, 128, 0),
    (64, 512, 32, 128, 0),
    # (64, 512, 64, 128, 0), over shared memory
    #  (128,   256,   16,    128,    0), mtcc register rewriting failed
    (128, 256, 32, 128, 0),
    #  (128,   256,   64,    128,    0), hang
    (128, 512, 16, 128, 0),
    (128, 512, 32, 128, 0),
    # (128, 512, 64, 128, 0), over shared memory
]
test_params = [
