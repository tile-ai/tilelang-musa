...
block_threads_stages_list = [
    # (16, 64, 8, 128, 0), qy2 required m and n be multiple of 32
    # (16, 64, 16, 128, 0), qy2 required m and n be multiple of 32
    # (16, 64, 32, 128, 0), qy2 required m and n be multiple of 32``
    (32, 32, 16, 128, 0),
    (32, 32, 32, 128, 0),
    (32, 64, 8, 128, 0),
    (32, 64, 16, 128, 0),
    (32, 64, 32, 128, 0),
    # (64, 16, 8, 128, 0), qy2 required m and n be multiple of 32
    # (64, 16, 16, 128, 0), qy2 required m and n be multiple of 32
    # (64, 16, 32, 128, 0), qy2 required m and n be multiple of 32
    (64, 32, 8, 128, 0),
    (64, 32, 16, 128, 0),
    (64, 32, 32, 128, 0),
    (64, 64, 8, 128, 0),
