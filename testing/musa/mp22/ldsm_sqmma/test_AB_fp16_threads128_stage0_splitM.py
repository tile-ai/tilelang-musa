...
block_threads_stages_list = [
    ...
    (256, 64, 16, 128, 0),
    (256, 64, 32, 128, 0),
    # (256, 64, 64, 128, 0), over shared memory
    (512, 64, 16, 128, 0),
    (512, 64, 32, 128, 0),
    # (512, 64, 64, 128, 0), over shared memory
    # (256, 128, 16, 128, 0), mtcc register rewriting failed
    # (256, 128, 32, 128, 0), mtcc register rewriting failed
    # (256, 128, 64, 128, 0), mtcc unroll
    (512, 128, 16, 128, 0),
    (512, 128, 32, 128, 0),
