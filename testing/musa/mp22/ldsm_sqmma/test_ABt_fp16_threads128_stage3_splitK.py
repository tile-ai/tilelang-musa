...
block_threads_stages_list = [
    # (16, 64, 128, 128, 3), qy2 required m and n must be multiple of 32
    # (16, 64, 256, 128, 3), qy2 required m and n must be multiple of 32
    # (16, 64, 512, 128, 3), over shared memory
    (32, 32, 128, 128, 3),
    ...
    # (32, 128, 512, 128, 3), over shared memory
    # (64, 16, 128, 128, 3), qy2 required m and n must be multiple of 32
    ...
    # (128, 64, 256, 128, 3), over shared memory
    # (128, 64, 512, 128, 3), over shared memory
    # (128, 128, 128, 128, 3), over shared memory
    # (128, 128, 256, 128, 3), over shared memory
    # (128, 128, 512, 128, 3), over shared memory
]
test_params = [
