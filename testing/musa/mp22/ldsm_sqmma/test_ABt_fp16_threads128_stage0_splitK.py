...
block_threads_stages_list = [
    # (16, 64, 128, 128, 0), qy2 required m and n be multiple of 32
    # (16, 64, 256, 128, 0), qy2 required m and n be multiple of 32
    # (16, 64, 512, 128, 0), qy2 required m and n be multiple of 32
    (32, 32, 128, 128, 0),
    (32, 32, 256, 128, 0),
    (32, 32, 512, 128, 0),
    (32, 64, 128, 128, 0),
    (32, 64, 256, 128, 0),
    # (32, 64, 512, 128, 0), over shared memory
    (32, 128, 128, 128, 0),
    # (32, 128, 256, 128, 0), over shared memory
    # (32, 128, 512, 128, 0), over shared memory
    # (64, 16, 128, 128, 0), qy2 required m and n be multiple of 32
    # (64, 16, 256, 128, 0), qy2 required m and n be multiple of 32
    # (64, 16, 512, 128, 0), qy2 required m and n be multiple of 32
    (64, 32, 128, 128, 0),
    (64, 32, 256, 128, 0),
    # (64, 32, 512, 128, 0), over shared memory
    (64, 64, 128, 128, 0),
    (64, 64, 256, 128, 0),
    # (64, 64, 512, 128, 0), over shared memory
    (64, 128, 128, 128, 0),
    # (64, 128, 256, 128, 0), over shared memory
    # (64, 128, 512, 128, 0), over shared memory
    (128, 32, 128, 128, 0),
    # (128, 32, 256, 128, 0), over shared memory
    # (128, 32, 512, 128, 0), over shared memory
    (128, 64, 128, 128, 0),
    # (128, 64, 256, 128, 0), over shared memory
    # (128, 64, 512, 128, 0), over shared memory
    (128, 128, 128, 128, 0),
