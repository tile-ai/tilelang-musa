...
block_threads_stages_list = [
    # (16, 64, 16, 128, 3), qy2 required m and n must be multiple of 32
    # (16, 64, 32, 128, 3), qy2 required m and n must be multiple of 32
    # (16, 64, 64, 128, 3), qy2 required m and n must be multiple of 32
    (32, 32, 16, 128, 3),
    (32, 32, 32, 128, 3),
    (32, 32, 64, 128, 3),
    (32, 64, 16, 128, 3),
    ...
    (32, 128, 32, 128, 3),
    (32, 128, 64, 128, 3),
    # (64, 16, 16, 128, 3), qy2 required m and n must be multiple of 32
    # (64, 16, 32, 128, 3), qy2 required m and n must be multiple of 32
    # (64, 16, 64, 128, 3), qy2 required m and n must be multiple of 32
    (64, 32, 16, 128, 3),
    (64, 32, 32, 128, 3),
    (64, 32, 64, 128, 3),
    (64, 64, 16, 128, 3),
    ...
    (64, 128, 16, 128, 3),
    (64, 128, 32, 128, 3),
    # (64, 128, 64, 128, 3), over shared memory
    (128, 32, 16, 128, 3),
    (128, 32, 32, 128, 3),
    (128, 32, 64, 128, 3),
    (128, 64, 16, 128, 3),
    (128, 64, 32, 128, 3),
    # (128, 64, 64, 128, 3), over shared memory
    (128, 128, 16, 128, 3),
    (128, 128, 32, 128, 3),
    # (128, 128, 64, 128, 3), over shared memory
]
test_params = [
