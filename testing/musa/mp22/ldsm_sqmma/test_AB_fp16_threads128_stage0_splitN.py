...
block_threads_stages_list = [
    # (16, 128, 16, 128, 0), qy2 required m and n be multiple of 32
    # (16, 128, 32, 128, 0), qy2 required m and n be multiple of 32
    # (16, 128, 64, 128, 0), qy2 required m and n be multiple of 32
    # (16, 256, 16, 128, 0), qy2 required m and n be multiple of 32
    # (16, 256, 32, 128, 0), qy2 required m and n be multiple of 32
    # (16, 256, 64, 128, 0), hang
    # (16, 512, 16, 128, 0), qy2 required m and n be multiple of 32
    # (16, 512, 32, 128, 0), hang
    # (16, 512, 64, 128, 0), hang
    # (32, 256, 16, 128, 0), hang
    (32, 256, 32, 128, 0),
    (32, 256, 64, 128, 0),
    (32, 512, 16, 128, 0),
    (32, 512, 32, 128, 0),
    ...
    # (128, 256, 32, 128, 0), mtcc register rewriting failed
