...
block_threads_stages_list = [
    # (16, 64, 16, 128, 0), qy2 requires m and n must be multiple of 32
    # (16, 64, 32, 128, 0), qy2 requires m and n must be multiple of 32
    # (16, 64, 64, 128, 0), qy2 requires m and n must be multiple of 32
    (32, 32, 16, 128, 0),
    (32, 32, 32, 128, 0),
    (32, 32, 64, 128, 0),
    (32, 64, 16, 128, 0),
    ...
    (32, 128, 32, 128, 0),
    (32, 128, 64, 128, 0),
    # (64, 16, 16, 128, 0), qy2 requires m and n must be multiple of 32
    # (64, 16, 32, 128, 0), qy2 requires m and n must be multiple of 32
    # (64, 16, 64, 128, 0), qy2 requires m and n must be multiple of 32
    (64, 32, 16, 128, 0),
    (64, 32, 32, 128, 0),
    (64, 32, 64, 128, 0),
    (64, 64, 16, 128, 0),
