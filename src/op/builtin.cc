...
TVM_REGISTER_PASS_CONFIG_OPTION(kDisableSafeRobustCopyPredication, Bool);
...
TVM_REGISTER_PASS_CONFIG_OPTION(kDisableVectorizeSingleSide, Bool);
...
TIR_DEFINE_TL_BUILTIN(mul_half_float_to_bfloat16_x4)
    .set_num_inputs(2)
    .set_attr<TCallEffectKind>("TCallEffectKind",
                               Integer(CallEffectKind::kPure));
...
TIR_DEFINE_TL_BUILTIN(manual_tma_barrier)
    .set_num_inputs(1)
    .set_attr<TCallEffectKind>("TCallEffectKind",
                               Integer(CallEffectKind::kPure));
