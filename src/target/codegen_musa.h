...
private:
  ...
  // Global murand state
  std::string murand_random_generator_state;
  std::string murand_random_generator_state_type;
  ...
  // whether need ldsm helpers (ptx_ldmatrix/ptx_stmatrix)
  bool need_ldsm_h_{false};
  // whether need cooperative_groups.h
  bool need_cooperative_groups_{false};
  // whether need murand_kernel.h
  bool need_murand_kernel_h_{false};
