...
/*!
 * \file musa_int8_t.h
 * \brief Extra int8 intrisic for musa codegen.
 */
#ifndef TVM_TARGET_SOURCE_LITERAL_MUSA_INT8_T_H_
#define TVM_TARGET_SOURCE_LITERAL_MUSA_INT8_T_H_

static constexpr const char* _musa_int8_t_def = R"(
...
#if !defined(__MUSACC_RTC__) && defined(__MUSA_ARCH__)
...
#endif /* !__MUSACC_RTC__ && defined(__MUSA_ARCH__) */

#undef __SM_61_INTRINSICS_DECL__

)";

#endif  // TVM_TARGET_SOURCE_LITERAL_MUSA_INT8_T_H_
