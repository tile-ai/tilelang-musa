/*!
 * \file tl/musa/op/builtin.h
 * \brief CUDA-specific TileLang intrinsic Ops and compiler attributes.
 */

#ifndef TVM_TL_MUSA_OP_BUILTIN_H_
#define TVM_TL_MUSA_OP_BUILTIN_H_
...
/*!
 * \brief Return the sentinel dtype used for MUSA tensor-map parameters.
 */
inline DataType MUTensorMapType() { return DataType::UInt(8, 128); }
...
#endif // TVM_TL_MUSA_OP_BUILTIN_H_
