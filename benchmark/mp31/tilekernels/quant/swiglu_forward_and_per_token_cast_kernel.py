...
def swiglu_forward_and_per_token_cast(
    ...
    out = torch.empty((num_expanded_tokens, hidden), dtype=torch.float8_e4m3fn, device=x.device)
    out_sf = alloc_scaling_factors((num_expanded_tokens, hidden), out_config, device=x.device)
