...
def main() -> int:
    ...
    return run_cases_main(
        title="ModelOps Sparse MLA Decode Benchmark",
        default_case_names=[
            "sparse_mla_decode_fwd_pipelined_v1",
            "sparse_mla_decode_fwd_pipelined_v2",
        ],
        description="Run the ModelOps sparse MLA decode benchmarks.",
    )
