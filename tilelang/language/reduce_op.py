...
from tilelang.utils.language import retrieve_shape, _get_buffer, to_tile_region
...
def cumsum_fragment(
    ...
    tirx.call_intrin(
        "handle",
        tirx.op.Op.get("tl.tileop.cumsum"),
        to_tile_region(cumsum_smem, access_type="r"),
        to_tile_region(cumsum_smem, access_type="w"),
        dim,
        reverse,
    )
